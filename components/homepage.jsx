  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row justify-around items-center h-screen">
      ...
      <div className="text-center sm:text-left">
        ...
        <button type="button" onClick={handleDownloadResume}className="text-gray-900 bg-gray-100 hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2 mt-9">
