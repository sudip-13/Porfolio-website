...
export const HomePage: React.FC<HomePageProps> = ({ id }) => {
  ...
  return (
    ...
    <div className="text-center sm:text-left w-full sm:w-1/3">
      ...
      <p id='desc' className='text-base sm:text-lg md:text-xl mt-4 dark:text-white text-black'>Currently pursuing Bachelor of Technology in Computer Science & Engineering - Artificial Intelligence & Machine Learning at Brainware University, Barasat, my academic expedition spans from 2021 to 2025.</p>
